...
DISCOVERY_REFRESH_SEC="${DISCOVERY_REFRESH_SEC:-180}"
...
Environment=POLYEDGE_DISCOVERY_MAX_FUTURE_MS_5M=10800000
Environment=POLYEDGE_DISCOVERY_MAX_FUTURE_MS_15M=10800000
Environment=POLYEDGE_DISCOVERY_ENDDATE_LIMIT=100
Environment=POLYEDGE_DISCOVERY_ENDDATE_MAX_PAGES=20
Environment=POLYEDGE_DISCOVERY_VOLUME_MAX_PAGES=30
Environment=POLYEDGE_DISCOVERY_VOLUME_LIMIT=100
...
Environment=FORGE_MARKET_FUTURE_GUARD_MS=10800000
