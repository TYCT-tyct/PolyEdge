...
POLYEDGE_DISCOVERY_REFRESH_SEC=2
POLYEDGE_CH_URL=
POLYEDGE_CH_DATABASE=polyedge
POLYEDGE_CH_SNAPSHOT_TABLE=snapshot_100ms
POLYEDGE_CH_TTL_DAYS=30
POLYEDGE_REDIS_URL=
POLYEDGE_REDIS_PREFIX=polyedge
POLYEDGE_REDIS_TTL_SEC=7200
POLYEDGE_SINK_BATCH_SIZE=200
POLYEDGE_SINK_FLUSH_MS=1000
POLYEDGE_SINK_QUEUE_CAP=20000
EOF
