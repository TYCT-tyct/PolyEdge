...
impl Default for StrategyRuntimeConfig {
    fn default() -> Self {
        Self {
            entry_threshold_base: 0.4794565127868492,
            entry_threshold_cap: 0.6642154569947828,
            spread_limit_prob: 0.013845267904995927,
            entry_edge_prob: 0.002,
            entry_min_potential_cents: 1.0,
            entry_max_price_cents: 85.70206506108863,
            min_hold_ms: 2_559,
            stop_loss_cents: 2.0,
            reverse_signal_threshold: -0.6077435579865155,
            reverse_signal_ticks: 1,
            trail_activate_profit_cents: 2.0,
            trail_drawdown_cents: 1.0,
            take_profit_near_max_cents: 85.40935112578856,
            endgame_take_profit_cents: 81.60106167284499,
            endgame_remaining_ms: 10_284,
            liquidity_widen_prob: 0.048391007619669586,
            cooldown_ms: 0,
            max_entries_per_round: 1,
            max_exec_spread_cents: 2.299833092578454,
            slippage_cents_per_side: 0.03,
            fee_cents_per_side: 0.03,
            emergency_wide_spread_penalty_ratio: 0.0,
        }
    }
}
