...
- Live safety defaults are strict by design:
  ...
  - `FORGE_FEV1_REQUIRE_FIXED_ENTRY_SIZE=true` blocks entry/add unless `FORGE_FEV1_FIXED_ENTRY_SIZE_SHARES` or `FORGE_FEV1_FIXED_ENTRY_QUOTE_USDC` is configured.
